    ...
    <>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          Passionate Frontend Developer with strong expertise in React,
          TypeScript, and modern UI/UX practices. Currently working at
          CRMPartners, where I design and implement scalable web applications
          and custom CRM integrations.
        </Text>
        <Text style={styles.text}>
          I thrive in dynamic environments, enjoy solving complex problems, and
          continuously seek opportunities to grow my skills and contribute to
          team success.
        </Text>
      </View>
        ...
        <View style={styles.item}>
          ...
          <View style={styles.bulletItem}>
            ...
            <Text style={styles.bulletText}>
              Developed complex web applications with React, improving
          ...
          <View style={styles.bulletItem}>
            <Text style={styles.bullet}>•</Text>
            <Text style={styles.bulletText}>
              Built custom widgets to optimize CRM platforms (Zoho, Freshworks,
              Zendesk), increasing workflow efficiency.
            </Text>
          </View>
          ...
          <View style={styles.bulletItem}>
            <Text style={styles.bullet}>•</Text>
            <Text style={styles.bulletText}>
              Integrated APIs with Java, Node.js, and Python to synchronize CRM
              data, reducing manual tasks by 40%.
            </Text>
          </View>
        </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.item}>
          ...
          <Text style={styles.text}>
            Main courses: C/C++, Java OOP, Data Structures, Algorithms, SQL,
            Mathematics.
          </Text>
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.item}>
          ...
          <Text style={styles.text}>
            ...
            qualification, and financial data from Creditsafe and Italian
            Chamber of Commerce.
          </Text>

          <Text style={styles.text}>
            Technologies: Next.js, TypeScript, Tailwind CSS, Zoho CRM API,
            Creditsafe API
          </Text>
        ...
        <View style={styles.item}>
          ...
          <Text style={styles.text}>
            An open-source npm package to standardize and simplify Git commit
            messages in Italian or English, following Conventional Commits
            guidelines and semantic versioning, all powered by AI.
          </Text>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          <Text style={{ fontWeight: 'bold' }}>Frontend:</Text> React,
          TypeScript, Next.js, Tailwind, Vite.js
        </Text>
        <Text style={styles.text}>
          <Text style={{ fontWeight: 'bold' }}>Testing:</Text> Playwright,
          Vitest, Accessibility
        </Text>
        <Text style={styles.text}>
          <Text style={{ fontWeight: 'bold' }}>Backend:</Text> Java, Python,
          REST APIs
        </Text>
        <Text style={styles.text}>
          <Text style={{ fontWeight: 'bold' }}>Tools:</Text> Git/GitHub, CI/CD,
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          Critical Thinking · Problem Solving · Teamwork · Stress Resilience ·
          Dedication
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>Italian (Native), English (B2)</Text>
      </View>
    </>
  )
}
